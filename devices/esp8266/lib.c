...
//=============================================
{
  ...
  msg = lib_publishMeta(co,da);
  //Serial.println(msg); 
  
  if (da->counter%50 == 0)
  {
      lib_publishConfig(co,da);
  }
...
//=============================================
{
  ...
  String stat_url = lib_buildUrlConfig(co);
  String dont_care = lib_wifiConnectandSend(co,da, stat_url);
}
//=============================================
String lib_publishConfig(struct Configuration *c2,struct Data *d2)
//=============================================
{
  String url,msg;
  url = lib_buildUrlConfig(&co);
  msg = lib_wifiConnectandSend(&co,&da, url);
  return msg;
}
//=============================================
String lib_publishMeta(struct Configuration *c2,struct Data *d2)
//=============================================
{
  String url,msg;
  url = lib_buildUrlMeta(&co,&da);
  msg = lib_wifiConnectandSend(&co,&da, url);
  return msg;
}
//=============================================
